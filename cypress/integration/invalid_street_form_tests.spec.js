describe('form test invalid street', () => {
    ...
    it('typed space in field street', () => {
        ...
        cy.get('input[data-key=street]').type('   ')  // typed space
        ...
        cy.get('input[data-key=community]').type('Gmina')
        ...
        cy.get('.text-center').contains('Ulica').should('be.visible')
    })
})
